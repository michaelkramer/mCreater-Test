...
public class Furnacegui01Gui extends TestElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Furnacegui01Gui(TestElements instance) {
		super(instance, 2);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("furnacegui01"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new Slot(internal, 0, 26, 21) {
			}));
			this.customSlots.put(1, this.addSlot(new Slot(internal, 1, 26, 57) {
			}));
			this.customSlots.put(2, this.addSlot(new Slot(internal, 2, 134, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Test.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("test:textures/furnacegui01.png");
		@Override
